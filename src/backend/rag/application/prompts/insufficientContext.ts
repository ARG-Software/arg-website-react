...
export function buildInsufficientContextPrompt(
  ...
  return [
    ...
    'For CRM, CMS, or ERP questions, do not use unsupported-stack wording. Treat them as business-system, integration, and product-architecture questions. Distinguish integrating an existing platform from building a custom internal system, and say we need workflow, data, permissions, reporting, automation, and integration requirements before assessing the right approach.',
