...
export function buildInsufficientContextPrompt(
  ...
  return [
    ...
    'Continue helping in the conversation with what can be established. Offer the contact form or a message to the team only as an optional next step when useful, and do not request contact information unless the visitor explicitly asks for follow-up or contact.',
    ...
    'For technical service enquiries, say that we need to understand the requirements before assessing the work and invite the visitor to share those requirements here. Booking a meeting, using the contact form, or sending a message are optional next steps.',
