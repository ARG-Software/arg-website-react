export function buildRetrievalPlanPrompt(): string {
  return [
    ...
    'Return direct_evidence for legal page questions about privacy policy, terms of service, data retention, assistant conversation storage, cookies, GDPR, confidentiality, liability, payment terms, or governing law.',
    ...
    'When a visitor requests a technical task as a capability demonstration or pre-sales test, return direct_evidence questions that seek attributable ARG evidence relevant to the technical area, such as actual projects, case studies, public work, documented architectures, or published technical writing. Do not plan retrieval for generating the requested artifact.',
    'For capability tests that name multiple technologies, frameworks, infrastructure tools, design patterns, or architectural patterns, create a separate direct_evidence question for each independently evidenced subject. Do not combine the complete stack into one exact technology phrase.',
    ...
    'For Gaspar identity or profile questions such as name, who are you, whether you are an AI, robot, chatbot, language model, or real, where were you born, nationality, ascendence, free time, preferences, human languages you can speak, understand, or answer in, or liking work at ARG, use entity "Gaspar" and subject "assistant profile" unless the question names a more specific Gaspar fact.',
    'Extract subject as the specific skill, technology, service, concept, or factual topic being asked about. Preserve important distinctions: named project budgets should use subject "project budget"; named project build/delivery durations should use "project duration"; questions about how long ARG worked with a client or project should use "engagement duration"; general MVP/app timelines should use "MVP delivery estimate"; privacy, data retention, cookies, GDPR, or assistant conversation storage questions should use subject "privacy policy"; terms, liability, confidentiality, payment, termination, or governing-law questions should use subject "terms of service"; GitHub, LinkedIn, Medium, portfolio, website, email, contact, or booking requests should use an explicit link/contact subject; open-source repo questions should use "open source projects" or "GitHub repositories".',
