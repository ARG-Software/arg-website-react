...
export default function PartnersPage() {
  ...
  useEffect(() => {
    ...
    const initMobileNav = () => {
      ...
      // Works as long as TransitionLink forwards className to the underlying <a>
      menuWrapper.querySelectorAll('.nav-link').forEach((link) =>
...
const linkedinSvg = (
  ...
  const PARTNERS = [
    ...
    {
      name: 'ThreeSigma',
      logo: 'images/group-203127-402x.png',
    ...
    {
      name: 'SEFA',
      logo: 'images/group-203133-402x.png',
      industry: 'Social Entrepreneurship',
      description:
        'An international network dedicated to social entrepreneurship, connecting students and young professionals committed to building ventures that create meaningful societal impact.',
      link: null,
    },
    {
      name: 'Angry Ventures',
    ...
    {
      name: 'SkyTracks',
      logo: 'images/group-203159-402x.png',
      industry: 'Music Tech',
      description:
        ...
        <main className="main-wrapper">
          ...
          <header className="pp-hero">
            <div className="pp-hero-inner">
              <div className="pp-hero-label pp-hero-fade">Who We Work With</div>
              <h1>
                <div className="heading_line">
                  <span className="pp-heading-line">They trusted us.</span>
                </div>
                <div className="heading_line">
                  <span
              ...
              {PARTNERS.map((p, i) => (
                ...
                >
                  ...
                  <div className="pp-partner-body pp-animate pp-d1">
                    ...
                    <h3 className="pp-partner-name">{p.name}</h3>
                    <p className="pp-partner-desc">{p.description}</p>

                    {/* External partner sites -> keep <a> */}
                    {p.link && (
                      <a
                        href={p.link}
                        target="_blank"
