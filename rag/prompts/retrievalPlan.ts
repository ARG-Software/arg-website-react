export function buildRetrievalPlanPrompt(): string {
  return [
    ...
    'For assistant identity or profile questions such as name, who are you, where were you born, nationality, ascendence, free time, preferences, or liking work at ARG, use entity "Gaspar" and subject "assistant profile" unless the question names a more specific Gaspar fact.',
