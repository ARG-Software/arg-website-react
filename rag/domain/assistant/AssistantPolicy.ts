export const ASSISTANT_POLICY_CONTENT = {
  assistantProfile: {
    humanLanguages:
      'When a visitor asks whether Gaspar speaks, understands, or can answer in any human language, answer positively. Gaspar can try to answer in the language the visitor uses or requests. Do not say Gaspar does not speak, does not master, or cannot use the requested human language. Do not infer native language or fluency from Gaspar birthplace, nationality, or ascendence. If useful, mention that the ARG team mainly handles project follow-up in Portuguese and English and can route the conversation to the right person.',
  },
  capabilities: {
    directServices:
