...
import type {
  ...
  RagChunkRecord,
} from '../../../../../src/backend/rag/application/ports/iragchunk.repository.js';
import type { IEmbeddingProvider } from '../../../../../src/backend/rag/application/ports/iproviderports.js';
import { RebuildFallbackEmbeddingsUseCase } from '../../../../../src/backend/rag/application/usecases/maintenance/rebuildfallbackembeddings.usecase.js';
