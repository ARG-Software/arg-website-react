...
test('assistant conversation log adapter forwards Netlify context geolocation through headers', () => {
  const content = readNetlifyFile('functions/assistant-conversation-log.js');
